...
<div class=''>
  <el-container style="height: 100%; border: 1px solid #eee">
    <el-aside width="200px" style="background-color: rgb(238, 241, 246)">
      <el-menu router :default-openeds="['0','1']" v-for="(item,index) in $router.options.routes"  v-bind:key="index">
    ...
    <el-main>
      <el-form ref="form" :model="form" label-width="80px" :rules="rules">
        ...
        <!-- 按钮 -->
        <el-form-item>
          <el-button type="success" @click="submitForm('form')">保存修改</el-button>
...
created() {
  ...
  this._findByJid(this.$route.params.jid)
  this._listCategory()
